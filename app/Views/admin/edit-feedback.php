              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Edit Feedback ID: <?php echo $id . '->' . $sid ?></h4>
                    ...
                    <form class="forms-sample" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" value="<?php echo $date ?>" name="tanggal">
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1">Textarea</label>
                        <textarea name="balasan" class="form-control" id="exampleTextarea1" rows="4"><?php echo $text; ?></textarea>
                      </div>
