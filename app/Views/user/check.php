            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-xl-6 col-6">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="" id="" value="">
                            <label class="form-check-label" for="inlineRadio2">2 Piring</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="" id="" value="">
                            <label class="form-check-label" for="inlineRadio2">>2 Piring</label>
                    ...
                    <div class="col-xl-6 col-6">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="" id="" value="">
                            <label class="form-check-label" for="inlineRadio2">Malam</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="" id="" value="">
                    ...
                    <div class="row g-3 align-items-center">
                    <div class="col-xl-6 col-5">
                        <p>10. Kapan anda mengonsumsi sayuran?</p>
                    </div>
                    <div class="col-xl-6 col-6">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="" id="" value="">
                    ...
                    <div class="row g-3 align-items-center">
                    <div class="col-xl-6 col-5">
                        <p>11. Kapan anda mengonsumsi buah-buahan?</p>
                    </div>
                    <div class="col-xl-6 col-6">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="" id="" value="">
                    ...
                    <div class="row g-3 align-items-center">
                    <div class="col-xl-6 col-5">
                        <p>13. Kapan anda mengonsumsi ikan laut?</p>
                    </div>
                    <div class="col-xl-6 col-6">
                    <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="" id="" value="">
